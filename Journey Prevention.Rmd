...
abc123 <- abc_risk_subset[which(abc_risk_subset$USERID == 73833 & abc_risk_subset$EVENTDATE >= '2021-09-01' & abc_risk_subset$EVENTDATE <= '2022-03-18'),]


aaa <- Comp_DF[which(Comp_DF$USERID == 73833 & Comp_DF$PERIOD == 1),]
